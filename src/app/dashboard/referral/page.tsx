  ...
  useEffect(() => {
    const fetchUserData = async () => {
      const userData: User = {
        ...
        earnings: 250000, // Naira currency
        referrals: 5,
        notifications: [
    ...
    <div className="p-6  max-w-full mx-auto text-center bg-gradient-to-b from-gray-900 to-gray-900 min-h-screen mt-16 w-full overflow-x-hidden">
      ...
      <div className="mt-8 bg-gray-800 p-4 md:p-6 rounded-xl shadow-lg border border-gray-700 w-full">
        ...
        <div className="mt-4 flex flex-col md:flex-row justify-center items-center space-y-3 md:space-y-0 md:space-x-3 bg-gray-700 p-3 rounded-lg w-full">
          <span className="text-lg md:text-xl font-semibold text-gray-200 break-words">{user.referralCode}</span>
          <button
      ...
      <div className="mt-8 bg-gray-800 p-4 md:p-6 rounded-xl shadow-lg border border-gray-700 w-full">
        ...
        <div className="mt-4 bg-gradient-to-r from-blue-700 to-blue-600 p-4 rounded-lg flex flex-col md:flex-row justify-between text-gray-200">
          <span className="mb-2 md:mb-0">Total Earnings: <b className="text-blue-300">₦{user.earnings.toLocaleString()}</b></span>
      ...
      <div className="mt-8 bg-gray-800 p-4 md:p-6 rounded-xl shadow-lg border border-gray-700 w-full">
        ...
        <div className="mt-4 space-y-3">
          ...
          <details className="bg-gray-700 p-3 rounded-lg hover:bg-gray-600 transition-all">
            ...
            <p className="text-sm mt-2 text-gray-400">
              You earn <b className="text-green-400">₦100,000 per successful investor</b>. No limits!
            </p>
          </details>
        </div>
      </div>
